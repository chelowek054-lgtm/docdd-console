...
`,
  ...
  'docs/development/tasks/T-0001-offline.md': fm({
    id: 'T-0001', type: 'task', title: 'Сделать работу без сети', status: 'done',
    created: '2026-07-05', updated: '2026-08-25',
    links: { implements: ['R-0001'], documents: ['D-0001'], verified_by: ['V-0001'] }
  }, 'Задача закрыта, проверка пройдена.'),

  'docs/development/tasks/T-0002-weights.md': fm({
    id: 'T-0002', type: 'task', title: 'Вынести веса модели клёва', status: 'in_progress',
  ...
  'docs/development/tasks/T-0003-broken-link.md': fm({
    id: 'T-0003', type: 'task', title: 'Задача со ссылкой в никуда', status: 'ready',
  ...
  'docs/development/tasks/T-0004-cycle-a.md': fm({
    id: 'T-0004', type: 'task', title: 'Первая половина цикла', status: 'backlog',
  ...
  'docs/development/tasks/T-0005-cycle-b.md': fm({
    id: 'T-0005', type: 'task', title: 'Вторая половина цикла', status: 'backlog',
    created: '2026-07-20', updated: '2026-07-20',
    links: { depends_on: ['T-0004'] }
  }, 'Ждёт первую половину.'),

  'docs/development/tasks/T-0006-unverified.md': fm({
    id: 'T-0006', type: 'task', title: 'Закрыта с непройденной проверкой', status: 'done',
    created: '2026-07-20', updated: '2026-08-25',
    links: { implements: ['R-0001'], verified_by: ['V-0002'] }
  }, 'Проверка в последнем отчёте не прошла.'),

  'docs/development/tasks/T-0007-doc-later.md': fm({
    id: 'T-0007', type: 'task', title: 'Документ изменён после закрытия', status: 'done',
    created: '2026-07-20', updated: '2026-08-10',
    links: { implements: ['R-0001'], documents: ['D-0001'] }
...
`,
  ...
  'docs/development/tasks/T-0011-wrong-link.md': fm({
    id: 'T-0011', type: 'task', title: 'Связь ведёт не туда', status: 'ready',
    created: '2026-07-20', updated: '2026-08-28',
    links: { implements: ['D-0001'] }
