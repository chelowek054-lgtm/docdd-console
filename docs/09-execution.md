...
У модели в дереве задачи есть Bash — она вправе закоммитить сама, не дожидаясь
«Принять» (шаг 3 выше). Дифф от этого не пропадает: «что наработано» считается
от точки, где ветка задачи разошлась с вашей, а не только по грязному рабочему
дереву — закоммичено оно или нет, не важно. «Принять» в этом случае просто не
коммитит заново поверх уже готового коммита.
