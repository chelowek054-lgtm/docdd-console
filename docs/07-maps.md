...
Модель вызывается **снаружи** приложения: человек или его агент запрашивает
карту по шаблону из `docs/prompts/`, кладёт ответ в запись и правит его руками,
пока он не станет правдой. Приложение к моделям не обращается никогда.
