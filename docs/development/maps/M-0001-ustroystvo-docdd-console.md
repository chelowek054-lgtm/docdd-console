...
```docdd-codemap
{
    "added": {
      ...
      "imports": [
        ...
        {"from":"server/utils/inbox-service.ts","to":"server/lib/scaffold.ts","evidence":{"path":"server/utils/inbox-service.ts","line":6,"fragment":"import { nextId, recordTemplate, slugify } from '../lib/sc"}},
...
```docdd-userflow
{
    "added": {
      ...
      "calls": [
        ...
        {"from":"/projects/:id/inbox","to":"POST /api/projects/:id/inbox/preview","evidence":{"path":"app/pages/projects/[id]/inbox.vue","line":111,"fragment":"    `/api/projects/${projectId.value}/inbox/preview`,"}},
        {"from":"/projects/:id/inbox","to":"POST /api/projects/:id/inbox/records","evidence":{"path":"app/pages/projects/[id]/inbox.vue","line":131,"fragment":"      `/api/projects/${projectId.value}/inbox/records`,"}},
        {"from":"/projects/:id/inbox","to":"POST /api/projects/:id/prompt","evidence":{"path":"app/pages/projects/[id]/inbox.vue","line":95,"fragment":"    { method: 'POST', body: { kind: 'inbox', notes: notes.va"}},
        {"from":"/projects/:id/inbox","to":"POST /api/projects/:id/inbox/notes","evidence":{"path":"app/pages/projects/[id]/inbox.vue","line":41,"fragment":"      `/api/projects/${projectId.value}/inbox/notes`,"}},
