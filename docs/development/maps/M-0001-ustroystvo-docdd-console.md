...
```docdd-codemap
{
    "added": {
      ...
      "imports": [
        ...
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/lib/inventory.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":18,"fragment":"import { worthAsking } from '../../../../lib/inventory';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/lib/map-schemas.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":17,"fragment":"import { mapSchemas } from '../../../../lib/map-schemas';"}},
        ...
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/lib/prompt.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":14,"fragment":"} from '../../../../lib/prompt';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/lib/workspace.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":22,"fragment":"import { readWorkspace, sourceReader, WorkspaceError } from "}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/chosen.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":20,"fragment":"import { pickedIssues } from '../../../../utils/chosen';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/fix-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":19,"fragment":"import { chosenIssues } from '../../../../utils/fix-service'"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/http.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":23,"fragment":"import { fail } from '../../../../utils/http';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/inbox-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":16,"fragment":"import { inboxNotes } from '../../../../utils/inbox-service'"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/index-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":24,"fragment":"import { loadIndex } from '../../../../utils/index-service';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/inventory-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":21,"fragment":"import { inventoryOf } from '../../../../utils/inventory-ser"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/map-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":25,"fragment":"import { buildProjectMap } from '../../../../utils/map-servi"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/projects.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":26,"fragment":"import { findProject } from '../../../../utils/projects';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/shared-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":15,"fragment":"import { connectedPractices } from '../../../../utils/share"}},
