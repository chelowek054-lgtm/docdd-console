...
```docdd-codemap
{
    "added": {
      ...
      "imports": [
        ...
        {"from":"app/pages/projects/[id]/shared.vue","to":"server/utils/shared-service.ts","evidence":{"path":"app/pages/projects/[id]/shared.vue","line":3,"fragment":"import type { SharedSourceView } from '~~/server/utils/share"}},
        ...
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/lib/workspace.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":13,"fragment":"import { readWorkspace, sourceReader, WorkspaceError } from "}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/chosen.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":11,"fragment":"import { pickedIssues } from '../../../../utils/chosen';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/fix-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":10,"fragment":"import { chosenIssues } from '../../../../utils/fix-service'"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/http.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":14,"fragment":"import { fail } from '../../../../utils/http';"}},
        ...
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/index-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":15,"fragment":"import { loadIndex } from '../../../../utils/index-service';"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/inventory-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":12,"fragment":"import { inventoryOf } from '../../../../utils/inventory-ser"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/map-service.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":16,"fragment":"import { buildProjectMap } from '../../../../utils/map-servi"}},
        {"from":"server/api/projects/[id]/prompt/index.post.ts","to":"server/utils/projects.ts","evidence":{"path":"server/api/projects/[id]/prompt/index.post.ts","line":17,"fragment":"import { findProject } from '../../../../utils/projects';"}},
        ...
        {"from":"server/lib/scaffold.ts","to":"server/lib/write.ts","evidence":{"path":"server/lib/scaffold.ts","line":2,"fragment":"import { journalLine } from './write';"}},
        ...
        {"from":"server/utils/shared-service.ts","to":"server/lib/paths.ts","evidence":{"path":"server/utils/shared-service.ts","line":1,"fragment":"import { normalizeRoot } from '../lib/paths';"}},
        {"from":"server/utils/shared-service.ts","to":"server/lib/shared.ts","evidence":{"path":"server/utils/shared-service.ts","line":2,"fragment":"import { narrowDomainTypes, sharedRecordsOf, type SharedReco"}},
        {"from":"server/utils/shared-service.ts","to":"server/lib/types.ts","evidence":{"path":"server/utils/shared-service.ts","line":3,"fragment":"import type { SharedSource } from '../lib/types';"}},
        {"from":"server/utils/shared-service.ts","to":"server/lib/workspace.ts","evidence":{"path":"server/utils/shared-service.ts","line":4,"fragment":"import { WorkspaceError } from '../lib/workspace';"}},
        {"from":"server/utils/shared-service.ts","to":"server/utils/index-service.ts","evidence":{"path":"server/utils/shared-service.ts","line":5,"fragment":"import { loadIndex } from './index-service';"}},
