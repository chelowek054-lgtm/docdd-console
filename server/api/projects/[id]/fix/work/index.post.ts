...
import { acceptFix, borderOf, rejectFix } from '../../../../../utils/fix-service';
...
export default defineEventHandler(async (event) => {
  ...
  const body = await readBody<{ action?: unknown; actor?: unknown; codes?: unknown; severity?: unknown }>(event);
  ...
  // Граница считается заново из индекса: браузер называет фильтр, а не файлы.
